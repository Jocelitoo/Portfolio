    ...
    >
      ...
      <div className="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <div className="flex flex-col items-center gap-4 p-4 lg:items-start">
            <h3 className="font-bold text-xl">E-Shop</h3>

            <p className="text-center brightness-75 lg:text-start">
              Meu primeiro projeto utilizado Next.js. Nesse projeto, fiz um site
              de vendas de eletrônicos de uma maneira bem próxima dos e-commerce
              reais
            </p>

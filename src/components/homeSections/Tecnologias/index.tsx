...
import { h3CSS } from './style/h3-css';
import { pCSS } from './style/p-css';
...
export function Tecnologias() {
  ...
  return (
    <section
      id="tecnologias"
      className={`p-section ${darkMode ? 'text-white' : 'text-black'} flex flex-col items-center`}
    >
      <h2 className={h2CSS}>
        Tecnologias <span className={`${h2SpanCSS(darkMode)}`}></span>
      </h2>
      ...
      <div className="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Html5</h3>

          <p className={pCSS}>
            Linguagem de marcação de hipertexto para criar e estruturar o
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Css3</h3>

          <p className={pCSS}>
            Usado para definir estilos nos projetos web como cores, efeitos de
            transição, animações, etc.
          </p>
        </div>
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Javascript</h3>

          <p className={pCSS}>
            Linguagem de programação que permite a você implementar itens
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>React</h3>

          <p className={pCSS}>
            biblioteca JavaScript usada para a criação de interfaces de usuário
            com mais facilidade.
          </p>
        </div>
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Typescript</h3>

          <p className={pCSS}>
            linguagem de programação de código aberto desenvolvida pela
            Microsoft que é uma extensão do JavaScript. Ela adiciona recursos
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Git</h3>

          <p className={pCSS}>
            Sistema de controle de versões distribuído que registra quaisquer
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Github</h3>

          <p className={pCSS}>
            Plataforma de hospedagem de código-fonte e arquivos com controle de
            versão usando o Git.
          </p>
        </div>
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Node JS</h3>

          <p className={pCSS}>
            Software de código aberto que permite a execução de códigos
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Postgresql</h3>

          <p className={pCSS}>
            Sistema de gerenciamento de bancos de dados objeto-relacional de uso
            geral, um dos mais avançado sistema de banco de dados de código
            aberto.
          </p>
        </div>
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>MongoDB</h3>

          <p className={pCSS}>
            Sistema de gerenciamento de banco de dados que utiliza documentos
            flexíveis em vez de tabelas e linhas para processar e armazenar
            várias formas de dados.
          </p>
        </div>
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Prisma</h3>

          <p className={pCSS}>
            Biblioteca de código aberto para Node.js e TypeScript que atua como
            um intermediário entre sua aplicação e o banco de dados.
          </p>
        </div>
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Tailwind CSS</h3>

          <p className={pCSS}>
            Framework CSS visando a utilidade, que fornece várias classes
            utilitárias, opinativas e de propósito único, que você pode usar
            diretamente dentro de sua marcação de texto para projetar um
            elemento.
          </p>
        </div>
        ...
        <div className={`${divCSS(darkMode)}`}>
          ...
          <h3 className={h3CSS}>Vite</h3>

          <p className={pCSS}>
            Framework de desenvolvimento front-end que oferece uma experiência
            de desenvolvimento mais rápida e fluida, com builds de produção
            altamente otimizados.
          </p>
        </div>

        <div className={`${divCSS(darkMode)} relative`}>
          <svg
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
